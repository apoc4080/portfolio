  ...
  return (
    ...
    <a className="anchor" id="hero"></a>
      ...
      >
        ...
        >
          <img variants={slideIn("up", "tween", 0.2, 1)} src="./me33.png" alt="" />
        </div>
        ...
        <div className={css.lowerElements}>
          ...
          <div variants={fadeIn("left", "tween", 0.2, 1)} className={css.certificate}>
            <a target="_blank" href="https://drive.google.com/file/d/1mHF0tBl47NZtaNB9UPhckBYzeFoPY1Zd/view?usp=sharing"><img src="./down.jpg" alt="" /></a>
